...
proteins <- read.csv("resources/HitsPerProtein.csv.gz", sep = ",", header = T)
proteoforms <- read.csv("resources/HitsPerProteoform.csv.gz", sep = ",", header = T) 
...
png("docs/fig_5B.png", height = 12, width = 12, units = "cm", res = 600)
