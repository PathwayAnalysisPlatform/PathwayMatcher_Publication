# 
# This script plots the NOTCH pathway as a graph.
#
...
matchesFile <- "docs/resources/search.tsv.gz"
...
png(paste0("figures/paper/fig_1A.png"), height = 12, width = 12, units = "cm", res = 600)
plot(graphPlot)
dummy <- dev.off()
