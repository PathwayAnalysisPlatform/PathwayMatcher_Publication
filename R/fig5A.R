...
matchesFile <- "resources/network_1.8.1/search.tsv.gz"
...
# write.table(pathwayNames, "resources/pathwayProteoformShare.txt", row.names = F, col.names = T, sep = '\t', quote = F)
...
png("docs/fig_5A.png", height = 12, width = 12, units = "cm", res = 600)
plot(pathwayShare)
dummy <- dev.off()
