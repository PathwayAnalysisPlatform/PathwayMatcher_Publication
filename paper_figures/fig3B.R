...
proteins <- read.csv("docs/resources/HitsPerProtein.csv.gz", sep = ",", header = T)
proteoforms <- read.csv("docs/resources/HitsPerProteoform.csv.gz", sep = ",", header = T) 
...
png("figures/paper/fig_3B.png", height = 12, width = 12, units = "cm", res = 600)
